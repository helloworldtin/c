...
void analyze_card(bool *straight, bool* flush, bool *three, bool *four, int *pairs, int num_in_suit[], int num_in_rank[]);
...
int main(void)
{
    ...
    for(;;){
        ...
        analyze_card(&straight, &flush, &three, &four, &pairs, num_in_suit, num_in_rank);
